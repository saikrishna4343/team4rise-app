...
export default function CompletedTasksScreen({ navigation }: any) {
          ...
          <>
            <View style={styles.summaryCard}>
              <Text style={styles.summaryText}>
                You have <Text style={styles.summaryNumber}>{pendingChallenges.length}</Text> completed {pendingChallenges.length === 1 ? 'task' : 'tasks'}
              </Text>
            </View>
